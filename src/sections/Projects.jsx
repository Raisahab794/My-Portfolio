...
const Projects = () => {
  const [currentProject, setCurrentProject] = React.useState(myProjects[0])
  const handleNavigation = (direction) => {
    const currentIndex = myProjects.indexOf(currentProject)
    if (direction === 'prev') {
      if (currentIndex === 0) {
        return
      }
      setCurrentProject(myProjects[currentIndex - 1])
    } else {
  ...
  return (
      <section className='c-space my-20'>
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-5 w-full mt-12'>
            ...
            <div className='border border-black-300 rounded-lg bg-black-300 h-96 md:h-full'>
                  <Canvas>
